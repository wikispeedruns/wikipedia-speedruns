...
function generateStreakText(data)
{
    ...
    if (data['streak'] <= 5) {
        disp = `You currently have a 🔥<b> ${data['streak']} day streak </b>🔥, keep it up!`;
    } else if (data['streak'] <= 10) {
        disp = `Good to see you again! You currently have a 🔥<b> ${data['streak']} day streak </b>🔥, impressive!`;
    } else if (data['streak'] <= 25) {
        disp = `Woah, 🔥<b> ${data['streak']} day streak </b>🔥 and going strong!!`
    } else { 
        disp = `Didn't think you'd make it this far, but you did! Keep it up! 🔥<b> ${data['streak']} day streak </b>🔥!!`
    }
