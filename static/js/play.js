...
function getRandTip() {
    tips = [
        ...
        "Reminder: “Find on page” is against the rules!",
...
function countdownOnLoad(start, end) {
    ...
    var tipsHeader = document.createElement("p");
    tipsHeader.innerHTML = "Here's a tip that may or may not be helpful!"
    var tip = document.createElement("p");
    tip.innerHTML = getRandTip();

    tipsBlock.appendChild(tipsHeader);
    tipsBlock.appendChild(tip);
